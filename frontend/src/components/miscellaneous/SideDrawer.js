  ...
  return (
    <>
      ...
      >
        ...
        <Text fontSize="3xl" fontFamily="Work sans" as="b" color="white">
          Talk-Wave
        </Text>
        <div>
          <Menu>
          ...
          <Menu>
            ...
            <MenuList bg="blue.300">
              <ProfileModal user={user}>
                <MenuItem bg="blue.300">My Profile</MenuItem>
              </ProfileModal>
              <MenuDivider />
              <MenuItem onClick={logoutHandler} bg="blue.300">
                Logout
              </MenuItem>
            </MenuList>
          </Menu>
        ...
        <DrawerContent bg="blue.300">
          ...
          <DrawerBody>
            <Box style={{ display: "flex" }} pb={2}>
              ...
              />
              <Button onClick={handleSearch} bg="blue.100">
                Go
              </Button>
            </Box>
            {loading ? (
